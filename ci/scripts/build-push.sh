...
echo "cp -r hello-go-deploy-gce/hello-go-deploy-gce-code/* dist"
cp -r hello-go-deploy-gce/hello-go-deploy-gce-code/* dist
echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gce/hello-go-deploy-gce-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gce/hello-go-deploy-gce-code/build-push/Dockerfile" .
#echo " "
