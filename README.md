...
[![Maintainability](https://api.codeclimate.com/v1/badges/???????????????????/maintainability)](https://codeclimate.com/github/JeffDeCola/hello-go-deploy-gce/maintainability)
...
`hello-go-deploy-gce` _uses Concourse CI to test, build, push (to DockerHub) and
deploy a long running "hello-world" Docker Image to Google Compute Engine (gce)._

[hello-go-deploy-gce Docker Image](https://hub.docker.com/r/jeffdecola/hello-go-deploy-gce)
 on DockerHub.

[hello-go-deploy-gce GitHub Webpage](https://jeffdecola.github.io/hello-go-deploy-gce/).
